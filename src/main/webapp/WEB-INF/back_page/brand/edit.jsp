			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="radio" name="isDisplay" value="1" ${brand.isDisplay==1?"checked=\"checked\"":""}/>可用
						<input type="radio" name="isDisplay" value="0" ${brand.isDisplay==0?"checked=\"checked\"":""}/>不可用
					</td>
				</tr>
			</tbody>
			<tbody>
